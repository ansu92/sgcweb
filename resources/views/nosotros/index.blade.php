                                        ...
                                        <main
                                            ...
                                            <div class="sm:text-center lg:text-left">
                                                ...
                                                <p
                                                    ...
                                                    ¡Cobranza, facturación, información y reportes para tu condominio en
                                                    un solo
                                                    lugar!
                                                </p>
                        ...
                        <div class="container mx-auto">
                            ...
                            <section class="text-gray-600 body-font bg-gray-100">
                                <div class="container px-5 py-24 mx-auto">
                                    <div class="flex flex-col text-center w-full">
                                        ...
                                        <p
                                            class="text-gray-500 sm:text-lg md:text-xl lg:w-2/3 mx-auto leading-relaxed text-base text-justify">
                                            Es un sistema totalmente online para la administración de condominios,
                                            dirigidos
                                            por Juntas de Condominio y Administradores de Condominio, con sistema de
                                            roles y
                                            permisos, controlando el nivel de acceso que tienen los usuarios.</p>
                                        <p
                                            class="text-gray-500 sm:text-lg md:text-xl lg:w-2/3  mt-4 mx-auto leading-relaxed text-base text-justify">
                                            El sistema
                                            facilita la comunicación con el usuario al enviarle notificaciones de
                                            cobros, o
                                            recibos de condominio, a través de mensajes de texto o correo electrónico,
                                            para así
                                            mantener a la comunidad en contacto, además de ofrecer una cartelera virtual
                                            para
                                            que los administradores de distintas tareas del condominio publiquen sus
                                            comunicados.</p>
                                    </div>
                            ...
                            <section class="text-gray-600 body-font bg-white">
                                <div class="container px-5 py-24 mx-auto">
                                    <div class="flex flex-col text-center w-full mb-20">
                                        <h1
                                            class="text-gray-800 md:text-4xl text-4xl tracking-tight font-extrabold sm:text-5xl title-font  title-font">
                                            ¿Qué le ofrece SGC
                                            Web?</h1>
                                    </div>
                                        ...
                                        <div class="p-4 md:w-1/3">
                                            <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                                                <div class="flex items-center mb-3">
                                                    ...
                                                    <h2 class="text-gray-900 text-lg title-font font-medium">Responsivo
                                                    </h2>
                                                </div>
                                                <div class="flex-grow">
                                                    <p class="text-base text-justify">Sistema que se puede
                                                        utilizar desde un
                                                        teléfono celular, laptop, PC de escritorio o tablet, ofreciendo
                                                        un
                                                        manejo del sistema fácil e intuitivo, ajustando su tamaño para
                                                        adaptarse
                                                        al
                                        ...
                                        <div class="p-4 md:w-1/3">
                                            <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                                                <div class="flex items-center mb-3">
                                                    ...
                                                    <h2 class="text-gray-900 text-lg title-font font-medium">Sistema de
                                                        roles y
                                                        perfiles</h2>
                                                </div>
                                                <div class="flex-grow">
                                        ...
                                        <div class="p-4 md:w-1/3">
                                            <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                                                <div class="flex items-center mb-3">
                                                    ...
                                                    <h2 class="text-gray-900 text-lg title-font font-medium">Otras
                                                        funciones
                                                    </h2>
                                                </div>
                                                <div class="flex-grow">
                                                    <p class="text-base text-justify">También ofrece una
                                                        cartelera virtual,
                                                        un manual de usuario y genera varios reportes de información en
                                                        formato
                                                        PDF. Como extra, posee un sistema de mensajería para que los
                                                        miembros
                            ...
                            <section class="text-gray-600 body-font bg-gray-100">
                                <div class="container px-5 py-24 mx-auto">
                                    <div class="flex flex-col text-center w-full mb-20">
                                        <h1
                                            class="text-gray-800 md:text-4xl text-4xl tracking-tight font-extrabold sm:text-5xl title-font  title-font mb-4">
                                            Nuestro
                                            Equipo
                                        </h1>
                                    ...
                                    <div class="flex flex-wrap -m-4">
                                        <div class="p-4 lg:w-1/2">
                                            <div
                                                ...
                                                <div class="flex-grow sm:pl-8">
                                                    <h2 class="title-font font-medium text-lg text-gray-900">Anthony J.
                                                        Suárez
                                                    </h2>
                                        ...
                                        <div class="p-4 lg:w-1/2">
                                            <div
                                                ...
                                                <div class="flex-grow sm:pl-8">
                                                    <h2 class="title-font font-medium text-lg text-gray-900">Diego A.
                                                        Rodríguez
                                                    </h2>
                                                    <h3 class="text-gray-500 mb-3">TSU en Informática</h3>
                                        ...
                                        <div class="p-4 lg:w-1/2">
                                            <div
                                                ...
                                                <div class="flex-grow sm:pl-8">
                                                    <h2 class="title-font font-medium text-lg text-gray-900">Guillermo
                                                        Thourey
                                                    </h2>
                                                    <h3 class="text-gray-500 mb-3">TSU en Informática</h3>
                                        ...
                                        <div class="p-4 lg:w-1/2">
                                            <div
                                                ...
                                                <div class="flex-grow sm:pl-8">
                                                    <h2 class="title-font font-medium text-lg text-gray-900">Pablo
                                                        Bastardo
                                                    </h2>
                                                    <h3 class="text-gray-500 mb-3">TSU en Informática</h3>
