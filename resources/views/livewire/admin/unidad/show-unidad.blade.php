        ...
        <dl>
            ...
            @if ($unidad->propietario)
                <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                        {{ $unidad->propietario->integrante->nombre }} {{ $unidad->propietario->integrante->apellido }}
                    </dd>
                </div>
                        ...
                        <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    <div class="absolute inset-y-0 left-0 flex items-center">
                                        <select id="letra" name="letra"
                                            ...
                                            wire:model="integrante.letra">
                                            <option>V</option>
                                            <option>E</option>
                                        </select>
                                    </div>
                                    <input wire:model.lazy="integrante.documento" type="text" name="documento"
                                        id="documento"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input wire:model="integrante.s_apellido" type="text" name="s_apellido"
                                    id="s_apellido" autocomplete="street-address"
                                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
